...
import { getAll, postAdd, postBulk, deleteData, updateData } from "../../../../apiQuery/kepalaLab.query";
...
const KepalaLab = () => {
    ...
    const { status, data } = useQuery(['kepalaLab'], () => getAll(user?.accessToken))
    ...
    const addSingleDosen = useMutation(postAdd, {
        onSuccess: () => {
            queryClient.invalidateQueries('kepalaLab')
        }
    })
    ...
    document.title = "Kepala Laboratorium | Velzon - React Admin & Dosen Pembimbing Template";
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Kepala Laboratorium" pageTitle="Kepala Laboratorium" />
